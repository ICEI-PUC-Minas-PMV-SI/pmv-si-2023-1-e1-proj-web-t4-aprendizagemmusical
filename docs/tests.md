...
|Link do vídeo do teste realizado: | docs/img/ct-tema-idioma.mp4 |
...
|Link do vídeo do teste realizado: | docs/img/ct-notas.mp4 | 

|*Caso de Teste*                                 |*TC-03 - O site deverá ser responsivo permitindo a visualização em um celular de forma adequada*                                         |
|---|---|
|Requisito Associado | RF-03 |
|Link do vídeo do teste realizado: | docs/img/ct-responsividade.mp4 | 
